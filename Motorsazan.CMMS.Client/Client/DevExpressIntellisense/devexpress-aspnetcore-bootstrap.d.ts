...
declare namespace DevExpress.AspNetCore {
    ...
    class Control {
        ...
        off<K extends keyof ControlEventMap>(eventName: K): this;
        off<K extends keyof ControlEventMap>(eventName: K, callback: (this: Control, args?: ControlEventMap[K]) => void): this;
    }
    ...
    class BootstrapGridView extends BootstrapGridBase {
        ...
        groupBy(column: BootstrapGridViewColumn, groupIndex: number): void;
        groupBy(columnIndex: number, groupIndex: number): void;
        groupBy(columnFieldNameOrId: string, groupIndex: number): void;
        groupBy(column: BootstrapGridViewColumn, groupIndex: number, sortOrder: string): void;
        ...
        sortBy(columnIndex: number): void;
        sortBy(columnFieldNameOrId: string): void;
        sortBy(column: BootstrapGridViewColumn, sortOrder: string): void;
        sortBy(columnIndex: number, sortOrder: string): void;
        sortBy(columnFieldNameOrId: string, sortOrder: string): void;
        sortBy(column: BootstrapGridViewColumn, sortOrder: string, reset: boolean): void;
        sortBy(columnIndex: number, sortOrder: string, reset: boolean): void;
        sortBy(columnFieldNameOrId: string, sortOrder: string, reset: boolean): void;
        sortBy(column: BootstrapGridViewColumn, sortOrder: string, reset: boolean, sortIndex: number): void;
        sortBy(columnIndex: number, sortOrder: string, reset: boolean, sortIndex: number): void;
        sortBy(columnFieldNameOrId: string, sortOrder: string, reset: boolean, sortIndex: number): void;
    ...
    class BootstrapPopupControl extends Control {
        ...
        setWindowAdaptiveMaxHeight(window: BootstrapPopupWindow, maxHeight: string): void;
        setWindowAdaptiveMaxWidth(window: BootstrapPopupWindow, maxWidth: number): void;
        setWindowAdaptiveMaxWidth(window: BootstrapPopupWindow, maxWidth: string): void;
        setWindowAdaptiveMinHeight(window: BootstrapPopupWindow, minHeight: number): void;
        setWindowAdaptiveMinHeight(window: BootstrapPopupWindow, minHeight: string): void;
        setWindowAdaptiveMinWidth(window: BootstrapPopupWindow, minWidth: number): void;
        setWindowAdaptiveMinWidth(window: BootstrapPopupWindow, minWidth: string): void;
        ...
        showWindow(window: BootstrapPopupWindow, popupElementIndex: number): void;
    ...
    class BootstrapUploadControlInvalidFileInfo extends Control {
        ...
        on<K extends keyof BootstrapUploadControlInvalidFileInfoEventMap>(eventName: K, callback: (this: BootstrapUploadControlInvalidFileInfo, args?: BootstrapUploadControlInvalidFileInfoEventMap[K]) => void): this;
        once<K extends keyof BootstrapUploadControlInvalidFileInfoEventMap>(eventName: K, callback: (this: BootstrapUploadControlInvalidFileInfo, args?: BootstrapUploadControlInvalidFileInfoEventMap[K]) => void): this;
        off<K extends keyof BootstrapUploadControlInvalidFileInfoEventMap>(eventName?: K, callback?: (this: BootstrapUploadControlInvalidFileInfo, args?: BootstrapUploadControlInvalidFileInfoEventMap[K]) => void): this;
    }
    ...
    class BootstrapUploadControlValidationSettings extends Control {
        ...
        on<K extends keyof BootstrapUploadControlValidationSettingsEventMap>(eventName: K, callback: (this: BootstrapUploadControlValidationSettings, args?: BootstrapUploadControlValidationSettingsEventMap[K]) => void): this;
        once<K extends keyof BootstrapUploadControlValidationSettingsEventMap>(eventName: K, callback: (this: BootstrapUploadControlValidationSettings, args?: BootstrapUploadControlValidationSettingsEventMap[K]) => void): this;
        off<K extends keyof BootstrapUploadControlValidationSettingsEventMap>(eventName?: K, callback?: (this: BootstrapUploadControlValidationSettings, args?: BootstrapUploadControlValidationSettingsEventMap[K]) => void): this;
    }
